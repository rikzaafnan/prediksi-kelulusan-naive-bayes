      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active" ><a href="lihat-data-testing-pengujian.php"><i class="fa fa-circle-o"></i> lihat data test pengujian</a></li>         
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active" >lihat data test pengujian</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
                ...
                <!-- tabel data training pengujian -->
                    <h3>Tabel data yang akan di gunakan untuk pengujian</h3>   		
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <?php
                                        $queri="Select * From tb_pengujian_test";
