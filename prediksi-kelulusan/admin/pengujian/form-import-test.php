      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active" ><a href="data-alumni.php"><i class="fa fa-circle-o"></i> Lihat Data Alumni</a></li>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                  <!-- buat download format excel nya -->
                    <form method="post" action="../import.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <button type='submit' name='import-pengujian-test' class='btn btn-primary'><span class='glyphicon glyphicon-upload'></span> Import</button>"    
                      </div>
                    </form>
                </div>
              </div>
