    ...
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="lihat-data-training-pengujian.php"><i class="fa fa-circle-o"></i> lihat data training pengujian</a></li>         
            <li><a href="lihat-data-testing-pengujian.php"><i class="fa fa-circle-o"></i> lihat data test pengujian</a></li>         
            <li class="active" ><a href="hasil-data-pengujian.php"><i class="fa fa-circle-o"></i> Hasil Pengujian Aplikasi</a></li>         
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active" >hasil data pengujian</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
                    ...
                    <table id="example2" class="table table-bordered table-striped">
                        <thead>
                            <tr  >
                                ...
                                <th text-align="center" colspan="3" >Prediksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <?php
                                    ...
                                    $sql ="SELECT * FROM tb_pengujian_test ORDER BY nama ASC";
                                    ...
                                    while ($data = mysqli_fetch_array($hasil)) {
                                        ...
                                        // perhitungan TAHAP 1
                                            ...
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            $totaldata = $result['jumlah'];

                                            // total data 'TEPAT' yang ada pada data training
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_kelulusan='TEPAT' group by status_kelulusan";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            ...
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_kelulusan='TERLAMBAT' group by status_kelulusan";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            ...
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where masa_studi =7";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            ...
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where masa_studi =8";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            ...
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where masa_studi =9";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            ...
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where masa_studi =10";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            ...
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where ipk_lulus >=3.51 and ipk_lulus <=4.00";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            ...
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where ipk_lulus >=2.76 && ipk_lulus <=3.50";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            ...
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where ipk_lulus >=2.00 && ipk_lulus <=2.75";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                            ...
                            <tr>
                                ...
                                <td id ="smasli"><?php echo $data[14]; ?></td>
                                <td id="msasli" ><?php echo $data[13]; ?></td>
                                <td id="piasli" >
                                     <?php
                                ...
                                <td id="sm" >
                                   <?php						
                                    //Status Mahasiswa 
                                        ...
                                        $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where jk = '$jeniskelamin' and status_kelulusan = 'TEPAT' group by jk";
                                        $query = mysqli_query($konek_db,$sql);
                                        $result = mysqli_fetch_array($query);
                                        ...
                                        $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where jk = '$jeniskelamin' and status_kelulusan = 'TERLAMBAT' group by jk";
                                        $query = mysqli_query($konek_db,$sql);
                                        $result = mysqli_fetch_array($query);
                                        ...
                                        $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_mahasiswa = '$statusmahasiswa' and status_kelulusan = 'TEPAT' group by status_mahasiswa";
                                        $query = mysqli_query($konek_db,$sql);
                                        $result = mysqli_fetch_array($query);
                                        ...
                                        $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_mahasiswa = '$statusmahasiswa' and status_kelulusan = 'TERLAMBAT' group by status_mahasiswa";
                                        $query = mysqli_query($konek_db,$sql);
                                        $result = mysqli_fetch_array($query);
                                        ...
                                        // QUERY IPK
                                            ...
                                            //standar deviasi IPS dengan keterangan TEPAT 
                                                $sql = "SELECT STD(ipk_1) FROM tb_pengujian WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $sdipk1tepat = $result[0];
                                                $sdipk1tepat = number_format($sdipk1tepat,3);
                                            //standar deviasi IPS dengan keterangan TEPAT 
                                                $sql = "SELECT STD(ipk_2) FROM tb_pengujian WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $sdipk2tepat = $result[0];
                                                $sdipk2tepat = number_format($sdipk2tepat,3);
                                            //standar deviasi IPS dengan keterangan TEPAT 
                                                $sql = "SELECT STD(ipk_3) FROM tb_pengujian WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $sdipk3tepat = $result[0];
                                                $sdipk3tepat = number_format($sdipk3tepat,3);
                                            //standar deviasi IPS dengan keterangan TEPAT 
                                                $sql = "SELECT STD(ipk_4) FROM tb_pengujian WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                            ...
                                            //standar deviasi IPS dengan keterangan TERLAMBAT 
                                                $sql = "SELECT STD(ipk_1) FROM tb_pengujian WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                            ...
                                            //standar deviasi IPS dengan keterangan TERLAMBAT 
                                                $sql = "SELECT STD(ipk_2) FROM tb_pengujian WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                            ...
                                            //standar deviasi IPS dengan keterangan TERLAMBAT 
                                                $sql = "SELECT STD(ipk_3) FROM tb_pengujian WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                            ...
                                            //standar deviasi IPS dengan keterangan TERLAMBAT 
                                                $sql = "SELECT STD(ipk_4) FROM tb_pengujian WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                        ...
                                        // QUERY IPS
                                            // Mean IPS1 dengan keterangan TEPAT 
                                                $sql = "SELECT AVG(ips_1) FROM tb_pengujian  WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $meanips1tepat = $result[0];
                                            // Mean IPS2 dengan keterangan TEPAT 
                                                $sql = "SELECT AVG(ips_2) FROM tb_pengujian  WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $meanips2tepat = $result[0];
                                            // Mean IPS3 dengan keterangan TEPAT 
                                                $sql = "SELECT AVG(ips_3) FROM tb_pengujian  WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $meanips3tepat = $result[0];
                                            // Mean IPS4 dengan keterangan TEPAT 
                                                $sql = "SELECT AVG(ips_4) FROM tb_pengujian  WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $meanips4tepat = $result[0];

                                            // Mean IPS1 dengan keterangan TERLAMBAT 
                                                $sql = "SELECT AVG(ips_1) FROM tb_pengujian  WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $meanips1terlambat = $result[0];
                                            // Mean IPS2 dengan keterangan TERLAMBAT 
                                                $sql = "SELECT AVG(ips_2) FROM tb_pengujian  WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $meanips2terlambat = $result[0];
                                            // Mean IPS3 dengan keterangan TERLAMBAT 
                                                $sql = "SELECT AVG(ips_3) FROM tb_pengujian  WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $meanips3terlambat = $result[0];
                                            // Mean IPS4 dengan keterangan TERLAMBAT 
                                                $sql = "SELECT AVG(ips_4) FROM tb_pengujian  WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $meanips4terlambat = $result[0];

                                            //standar deviasi dengan keterangan TEPAT 
                                                $sql = "SELECT STD(ips_1) FROM tb_pengujian WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $sdips1tepat = $result[0];
                                            //standar deviasi dengan keterangan TEPAT 
                                                $sql = "SELECT STD(ips_2) FROM tb_pengujian WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $sdips2tepat = $result[0];
                                            //standar deviasi dengan keterangan TEPAT 
                                                $sql = "SELECT STD(ips_3) FROM tb_pengujian WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $sdips3tepat = $result[0];
                                            //standar deviasi dengan keterangan TEPAT 
                                                $sql = "SELECT STD(ips_4) FROM tb_pengujian WHERE status_kelulusan = 'TEPAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $sdips4tepat = $result[0];

                                            //standar deviasi dengan keterangan TERLAMBAT 
                                                $sql = "SELECT STD(ips_1) FROM tb_pengujian WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $sdips1terlambat = $result[0];
                                            //standar deviasi dengan keterangan TERLAMBAT 
                                                $sql = "SELECT STD(ips_2) FROM tb_pengujian WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $sdips2terlambat = $result[0];
                                            //standar deviasi dengan keterangan TERLAMBAT 
                                                $sql = "SELECT STD(ips_3) FROM tb_pengujian WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                                $sdips3terlambat = $result[0];
                                            //standar deviasi dengan keterangan TERLAMBAT 
                                                $sql = "SELECT STD(ips_4) FROM tb_pengujian WHERE status_kelulusan = 'TERLAMBAT'";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                ...
                                <td id="ms" >
                                    ...
                                    //Jumlah Semester
                                        // Query mencari jenis kelamin dan status mahasisswa
                                            // total data 'jenis-kelamin yang dicari' yg 'TEPAT' pada data training
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where jk = '$jeniskelamin' and masa_studi =7 group by jk";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            $jkms7 = $result['jumlah'];  
                                            ...
                                            // total data 'jenis-kelamin yang dicari' yg 'TEPAT' pada data training
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where jk = '$jeniskelamin' and masa_studi =8 group by jk";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            $jkms8 = $result['jumlah'];  
                                            ...
                                            // total data 'jenis-kelamin yang dicari' yg 'TEPAT' pada data training
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where jk = '$jeniskelamin' and masa_studi =9 group by jk";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            $jkms9 = $result['jumlah'];  
                                            ...
                                            // total data 'jenis-kelamin yang dicari' yg 'TEPAT' pada data training
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where jk = '$jeniskelamin' and masa_studi =10 group by jk";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            ...
                                            // total data 'STATUS MAHASISWA yang dicari' yg 'TEPAT' pada data training
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_mahasiswa = '$statusmahasiswa' and masa_studi =7 group by status_mahasiswa";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            $smms7 = $result['jumlah'];
                                            ...
                                            // total data 'STATUS MAHASISWA yang dicari' yg 'TEPAT' pada data training
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_mahasiswa = '$statusmahasiswa' and masa_studi =8 group by status_mahasiswa";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            $smms8 = $result['jumlah'];
                                            ...
                                            // total data 'STATUS MAHASISWA yang dicari' yg 'TEPAT' pada data training
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_mahasiswa = '$statusmahasiswa' and masa_studi =9 group by status_mahasiswa";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                            $smms9 = $result['jumlah'];
                                            ...
                                            // total data 'STATUS MAHASISWA yang dicari' yg 'TEPAT' pada data training
                                            $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_mahasiswa = '$statusmahasiswa' and masa_studi =10 group by status_mahasiswa";
                                            $query = mysqli_query($konek_db,$sql);
                                            $result = mysqli_fetch_array($query);
                                    ...
                                    //Predikat IPK Kelulusan
                                        // Query mencari jenis kelamin dan status mahasisswa
                                            // total data 'jenis-kelamin yang dicari' dengan 'IPK antara 3.51 dan 4.00' pada data training 
                                                $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where jk = '$jeniskelamin' and ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                            ...
                                            // total data 'jenis-kelamin yang dicari' dengan 'IPK antara 2.76 dan 3.50' pada data training
                                                $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where jk = '$jeniskelamin' and ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                            ...
                                            // total data 'jenis-kelamin yang dicari' dengan 'IPK antara 2.00 dan 2.75' pada data training
                                                $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where jk = '$jeniskelamin' and ipk_lulus >=2.00 && ipk_lulus<=2.75";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                            ...
                                            // total data 'STATUS MAHASISWA yang dicari' dengan 'IPK antara 3.51 dan 4.00' pada data training
                                                $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_mahasiswa = '$statusmahasiswa' and ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                            ...
                                            // total data 'STATUS MAHASISWA yang dicari' dengan 'IPK antara 2.76 dan 3.50' pada data training
                                                $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_mahasiswa = '$statusmahasiswa' and ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                            ...
                                            // total data 'STATUS MAHASISWA yang dicari' dengan 'IPK antara 2.00 dan 2.75' pada data training
                                                $sql = "SELECT COUNT(*) AS jumlah FROM tb_pengujian where status_mahasiswa = '$statusmahasiswa' and ipk_lulus >=2.00 && ipk_lulus<=2.75";
                                                $query = mysqli_query($konek_db,$sql);
                                                $result = mysqli_fetch_array($query);
                                        ...
                                        // QUERY MEAN dan STANDAR DEVIASI IPK
                                            // Query ipk_lulus >=3.51 && ipk_lulus<=4.00 (cumlaude)
                                                // Mean IPK1 dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT AVG(ipk_1) FROM tb_pengujian  WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPK2 dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT AVG(ipk_2) FROM tb_pengujian  WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPK3 dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT AVG(ipk_3) FROM tb_pengujian  WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPK4 dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT AVG(ipk_4) FROM tb_pengujian  WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                //standar deviasi IPK dengan keterangan  semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT STD(ipk_1) FROM tb_pengujian WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdipk1cumlaude = $result[0];
                                                    $sdipk1cumlaude = number_format($sdipk1cumlaude,3);
                                                //standar deviasi IPK dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT STD(ipk_2) FROM tb_pengujian WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdipk2cumlaude = $result[0];
                                                    $sdipk2cumlaude = number_format($sdipk2cumlaude,3);
                                                //standar deviasi IPK dengan keterangan  semester ipk_lulus >=3.51 && ipk_lulus<=4.00
                                                    $sql = "SELECT STD(ipk_3) FROM tb_pengujian WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdipk3cumlaude = $result[0];
                                                    $sdipk3cumlaude = number_format($sdipk3cumlaude,3);
                                                //standar deviasi IPK dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT STD(ipk_4) FROM tb_pengujian WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                            ...
                                            // Query ipk_lulus >=2.76 && ipk_lulus<=3.50 (sgt memuaskan)
                                                // Mean IPK1 dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT AVG(ipk_1) FROM tb_pengujian  WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPK2 dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT AVG(ipk_2) FROM tb_pengujian  WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPK3 dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT AVG(ipk_3) FROM tb_pengujian  WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPK4 dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT AVG(ipk_4) FROM tb_pengujian  WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                //standar deviasi IPK dengan keterangan  semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT STD(ipk_1) FROM tb_pengujian WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdipk1sgtmemuaskan = $result[0];
                                                    $sdipk1sgtmemuaskan = number_format($sdipk1sgtmemuaskan,3);
                                                //standar deviasi IPK dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT STD(ipk_2) FROM tb_pengujian WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdipk2sgtmemuaskan = $result[0];
                                                    $sdipk2sgtmemuaskan = number_format($sdipk2sgtmemuaskan,3);
                                                //standar deviasi IPK dengan keterangan  semester ipk_lulus >=2.76 && ipk_lulus<=3.50
                                                    $sql = "SELECT STD(ipk_3) FROM tb_pengujian WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdipk3sgtmemuaskan = $result[0];
                                                    $sdipk3sgtmemuaskan = number_format($sdipk3sgtmemuaskan,3);
                                                //standar deviasi IPK dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT STD(ipk_4) FROM tb_pengujian WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                            ...
                                            // Query ipk_lulus >=2.00 && ipk_lulus<=2.75 (memuaskan)
                                                // Mean IPK1 dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT AVG(ipk_1) FROM tb_pengujian  WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPK2 dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT AVG(ipk_2) FROM tb_pengujian  WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPK3 dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT AVG(ipk_3) FROM tb_pengujian  WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPK4 dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT AVG(ipk_4) FROM tb_pengujian  WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                //standar deviasi IPK dengan keterangan  semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT STD(ipk_1) FROM tb_pengujian WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdipk1memuaskan = $result[0];
                                                    $sdipk1memuaskan = number_format($sdipk1memuaskan,3);
                                                //standar deviasi IPK dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT STD(ipk_2) FROM tb_pengujian WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdipk2memuaskan = $result[0];
                                                    $sdipk2memuaskan = number_format($sdipk2memuaskan,3);
                                                //standar deviasi IPK dengan keterangan  semester >=2.00 && ipk_lulus<=2.75
                                                    $sql = "SELECT STD(ipk_3) FROM tb_pengujian WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdipk3memuaskan = $result[0];
                                                    $sdipk3memuaskan = number_format($sdipk3memuaskan,3);
                                                //standar deviasi IPK dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT STD(ipk_4) FROM tb_pengujian WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                        ...
                                        // QUERY MEAN dan STANDAR DEVIASI IPS
                                            // Query ipk_lulus >=3.51 && ipk_lulus<=4.00 (cumlaude)
                                                // Mean IPS1 dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT AVG(ips_1) FROM tb_pengujian  WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPS2 dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT AVG(ips_2) FROM tb_pengujian  WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPS3 dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT AVG(ips_3) FROM tb_pengujian  WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPS4 dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT AVG(ips_4) FROM tb_pengujian  WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                //standar deviasi IPS dengan keterangan  semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT STD(ips_1) FROM tb_pengujian WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdips1cumlaude = $result[0];
                                                    $sdips1cumlaude = number_format($sdips1cumlaude,3);
                                                //standar deviasi IPS dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT STD(ips_2) FROM tb_pengujian WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdips2cumlaude = $result[0];
                                                    $sdips2cumlaude = number_format($sdips2cumlaude,3);
                                                //standar deviasi IPS dengan keterangan  semester ipk_lulus >=3.51 && ipk_lulus<=4.00
                                                    $sql = "SELECT STD(ips_3) FROM tb_pengujian WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdips3cumlaude = $result[0];
                                                    $sdips3cumlaude = number_format($sdips3cumlaude,3);
                                                //standar deviasi IPS dengan keterangan semester ipk_lulus >=3.51 && ipk_lulus<=4.00 
                                                    $sql = "SELECT STD(ips_4) FROM tb_pengujian WHERE ipk_lulus >=3.51 && ipk_lulus<=4.00";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                            ...
                                            // Query ipk_lulus >=2.76 && ipk_lulus<=3.50 (sgt memuaskan)
                                                // Mean IPS1 dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT AVG(ips_1) FROM tb_pengujian  WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPS2 dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT AVG(ips_2) FROM tb_pengujian  WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPS3 dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT AVG(ips_3) FROM tb_pengujian  WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPS4 dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT AVG(ips_4) FROM tb_pengujian  WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                //standar deviasi IPS dengan keterangan  semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT STD(ips_1) FROM tb_pengujian WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdips1sgtmemuaskan = $result[0];
                                                    $sdips1sgtmemuaskan = number_format($sdips1sgtmemuaskan,3);
                                                //standar deviasi IPS dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT STD(ips_2) FROM tb_pengujian WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdips2sgtmemuaskan = $result[0];
                                                    $sdips2sgtmemuaskan = number_format($sdips2sgtmemuaskan,3);
                                                //standar deviasi IPS dengan keterangan  semester ipk_lulus >=2.76 && ipk_lulus<=3.50
                                                    $sql = "SELECT STD(ips_3) FROM tb_pengujian WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdips3sgtmemuaskan = $result[0];
                                                    $sdips3sgtmemuaskan = number_format($sdips3sgtmemuaskan,3);
                                                //standar deviasi IPS dengan keterangan semester ipk_lulus >=2.76 && ipk_lulus<=3.50 
                                                    $sql = "SELECT STD(ips_4) FROM tb_pengujian WHERE ipk_lulus >=2.76 && ipk_lulus<=3.50";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                            ...
                                            // Query ipk_lulus >=2.00 && ipk_lulus<=2.75 (memuaskan)
                                                // Mean IPS1 dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT AVG(ips_1) FROM tb_pengujian  WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPS2 dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT AVG(ips_2) FROM tb_pengujian  WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPS3 dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT AVG(ips_3) FROM tb_pengujian  WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                // Mean IPS4 dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT AVG(ips_4) FROM tb_pengujian  WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                ...
                                                //standar deviasi IPS dengan keterangan  semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT STD(ips_1) FROM tb_pengujian WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdips1memuaskan = $result[0];
                                                    $sdips1memuaskan = number_format($sdips1memuaskan,3);
                                                //standar deviasi IPS dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT STD(ips_2) FROM tb_pengujian WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdips2memuaskan = $result[0];
                                                    $sdips2memuaskan = number_format($sdips2memuaskan,3);
                                                //standar deviasi IPS dengan keterangan  semester >=2.00 && ipk_lulus<=2.75
                                                    $sql = "SELECT STD(ips_3) FROM tb_pengujian WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                                                    $sdips3memuaskan = $result[0];
                                                    $sdips3memuaskan = number_format($sdips3memuaskan,3);
                                                //standar deviasi IPS dengan keterangan semester >=2.00 && ipk_lulus<=2.75 
                                                    $sql = "SELECT STD(ips_4) FROM tb_pengujian WHERE ipk_lulus>=2.00 && ipk_lulus<=2.75";
                                                    $query = mysqli_query($konek_db,$sql);
                                                    $result = mysqli_fetch_array($query);
                ...
                <!-- Akhir tabel responsive -->
                <hr>
            

            <div class="table-responsive">
            <h4><b>Pengujian Akurasi dengan Confusion Matrix</b></h4>
                <table class="table table-hover table-bordered">
                    <tr>
                        <th colspan="2" rowspan="2" >Clasification</th>
                        <th colspan="2">Predicated Class</th>
                    </tr>
                    <tr>
                        <th>Class = Yes / positive </th>
                        <th>Class = Yes / positive</th>
                    </tr>
                    <tr>
                        <th  rowspan="2">Observerd Class</th>
                        <th>Class = Yes / Positive</th>
                        <td>A ( True Positive = TP ) </td>
                        <td>B ( True Negative = TN )</td>                        
                    </tr>
                    <tr>
                        <th>Class = No / Negative</th>
                        <td>C ( False Positive = FP ) </td>
                        <td>D ( False Negative = FN )</td>
                    </tr>
                </table>
            </div>
            ...
            <ul class="nav nav-tabs">
                <li role="presentation">
                    <a href="#tab1" data-toggle="tab" >Akurasi dengan Confusion Matrix status kelulusan</a>
                </li>
                <li role="presentation">
                    <a href="#tab2" data-toggle="tab" >Akurasi dengan Confusion Matrix Masa studi</a>
                </li>
                <li role="presentation">
                    <a href="#tab3" data-toggle="tab" >Akurasi dengan Confusion Matrix predikat IPK kelulusan</a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane" id="tab1">
                    <div class="table-responsive">
                        <h4><b>Confusion Matrix pada Prediksi Status Mahasiswa</b></h4>
                        <table class="table table-hover table-bordered">
                            <tr>
                                <th colspan="2" rowspan="2" >Clasification</th>
                                <th colspan="2">Class Data Testing</th>
                            </tr>
                            <tr>
                                <th>Tepat</th>
                                <th>terlambat</th>
                            ...
                            <tr>
                                <th  rowspan="2">Prediction Class</th>
                                <th>Prediction Tepat</th>
                                <td>15</td>
                                <td>3</td>                        
                            </tr>
                            <tr>
                                <th>Prediction terlambat</th>
                                <td>0</td>
                                <td>0</td>
                            </tr>
                            <tr>
                                <td colspan="4" >Total data = 18 </td>
                            </tr>
                        </table>
                        <h4>Akurasi : (15 + 0)*100%/18 = <b>83.33%</b></h4>
                    </div>
                </div>
                <div class="tab-pane" id="tab2">
                    <div class="table-responsive">
                        <h4><b>Confusion Matrix pada Prediksi Masa Studi </b></h4>
                        <table class="table table-hover table-bordered">
                            <tr>
                                <th colspan="2" rowspan="2" >Clasification</th>
                                <th colspan="4">Class Data Testing</th>
                            </tr>
                            <tr>
                                <th>7</th>
                                <th>8</th>
                            ...
                            <tr>
                                <th  rowspan="4">Prediction Class</th>
                                <th>Prediction 7</th>
                                <td>13</td>
                                <td>1</td>
                                <td>2</td>                        
                            ...
                            <tr>
                                <td colspan="6" >Total data = 18 </td>
                            </tr>
                        </table>
                        <h4>Akurasi : (13 + 0+0+0)*100%/18 = <b>72.22%</b></h4>
                    </div>
                </div>
                <div class="tab-pane" id="tab3">
                    <div class="table-responsive">
                        <h4><b>Confusion Matrix pada Prediksi Predikat IPK kelulusan </b></h4>
                        <table class="table table-hover table-bordered">
                            <tr>
                                <th colspan="2" rowspan="2" >Clasification</th>
                                <th colspan="3">Class Data Testing</th>
                            </tr>
                            <tr>
                                <th>Cumlaude</th>
                            ...
                            <tr>
                                <th  rowspan="3">Prediction Class</th>
                                <th>Prediction Cumlaude</th>
                                <td>6</td>
                                <td>0</td>
                                <td>0</td>                                             
                            </tr>
                            <tr>
                                <th>Prediction Sangat Memuaskan</th>
                                <td>1</td>                        
                                <td>8</td>
                                <td>3</td>                       
                            </tr>
                            <tr>
                                <th>Prediction Memuaskan</th>
                                <td>0</td>                        
                                <td>0</td>
                                <td>0</td>                       
                            </tr>
                            <tr>
                                <td colspan="5" >Total data = 18 </td>
                            </tr>
                        </table>
                        <h4>Akurasi : (6 + 8+0)*100%/18 = <b>77.77%</b></h4>
                    </div>
                </div>
            </div>

            <h4>Akurasi pada Prediksi Status Kelulusan Mahassiswa adalah : <b>83.33%</b> </h4>
            <h4>Akurasi pada Prediksi masa Studi Mahassiswa adalah : <b>72.22%</b> </h4>
            <h4>Akurasi pada Prediksi Predikat kelulusan IPK mahasiswa adalah : <b>77.77%</b> </h4>
...
//   })
  function checkDelete() {
    ...
    var example2DOM = document.getElementById("example2"),coba;
    var bacabaris = example2DOM.rows.length;
    var tambahbaris = example2DOM.insertRow(bacabaris);
    var bacakolom = example2DOM.rows[8].cells.length;
    
    var smasliDOM = document.getElementById("smasli").innerHTML;
    var smDOM = document.getElementById("sm").innerHTML;
    
    
    for (let index = 3; index < bacabaris; index++) {
        var cellbaru =tambahbaris.insertCell(index);
        var testDOM = example2DOM.rows[8].cells[index];   
        cellbaru.innerHTML=testDOM
    }
    
    //  if (smasliDOM = smDOM) {
    //      testDOM.innerHTML ="true";
    //  } 

    
    // for (var i = 3; i < example2DOM.rows.length; i++) {

    //     testDOM.innerHTML="true";
        
    // } 
    var index = 3;
    // while (index<example2DOM.rows.length) {
    //     // testDOM.innerHTML="true";
    // } 
</script>
</body>
