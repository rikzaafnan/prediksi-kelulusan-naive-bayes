 ...
 * @Last Modified time: 2018-11-12 17:33:54
 */
  ...
  <div class="content-wrapper">
	...
	<div class="row content">
		<form name="form" id="myForm" method="post" enctype="multipart/form-data" action="tambah.php" >
                ...
                <div class="col-sm-8">
                    <input type="text" name="ms" class="form-control" required name="ms" data-error="Isi kolom dengan benar" value="">
                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    <div class="help-block with-errors" role="alert"></div>
                </div>
                </div>
          ...
          <div class="col-sm-8">
            <input type="text" name="ipk_lulus" class="form-control" required name="ipk_lulus" data-error="Isi kolom dengan benar" value="">
            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            <div class="help-block with-errors" role="alert"></div>
          </div>
        </div>
