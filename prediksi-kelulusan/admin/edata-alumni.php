        ...
        <br>                      
                        ...
                        <?php 
                            ...
                            {                           
                                ...
                                {
                                    echo "<script>alert('Data gagal ');window.location='edata-alumni.php?id=".$r[0]."'</script>";
                                    
                                }
                                    else
                                    {
                                        $query="UPDATE tb_datatraining SET nama='$nama', jk='$jk',status_mahasiswa='$sm',ipk_1=$ipk1,ipk_2=$ipk2,ipk_3=$ipk3,ipk_4=$ipk4,rataipk=$rataipk,ips_1=$ips1,ips_2=$ips2,ips_3=$ips3,ips_4=$ips4,masa_studi=$ms,status_kelulusan='$sk',ipk_lulus='$ipk_lulus' where nim='$nim'";
                                        $result=mysqli_query($konek_db, $query);
                                        if($result)
                                        {
                                            echo "<script>alert('Data telah diedit');window.location='data-alumni.php'</script>";
                                        }
                                    }
                            }
                        ?>  
